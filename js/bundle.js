...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector,activeClass) {
    ...
    function showTabContent(arg = 0) {
        tabsContent[arg].classList.add('show', 'fade');
        tabsContent[arg].classList.remove('hide');
        tabs[arg].classList.add(activeClass);
    }
...
function timer(id ,deadLine) {
    ...
    function setclock(seletor, endtime) {
        const timer = document.querySelector(seletor),
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2022-04-20');
